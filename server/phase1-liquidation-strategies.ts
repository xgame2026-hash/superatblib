...
export const PHASE1_LIQUIDATION_STRATEGIES: Phase1Strategy[] = [
  ...
  },
  {
    ...
    rpc: "ETHEREUM_RPC_URL",
    priority: 68,
    minCapitalUsd: 30_000,
    note: "覆盖 Morpho Blue 主网借贷市场，优先展示候选和健康因子快照。",
  },
  {
    id: "eth-spark-monitor",
    chain: "ethereum",
    chainLabel: "ETH",
    protocol: "Spark",
    strategy: "主网 Spark 清算监听",
    mode: "monitor",
    rpc: "ETHEREUM_RPC_URL",
    priority: 66,
    minCapitalUsd: 40_000,
    note: "监听 Spark 借贷仓位和可清算账户，默认不自动成交。",
  },
  {
  ...
  {
    id: "bnb-morpho-blue-monitor",
    chain: "bnb",
    chainLabel: "BNB",
    protocol: "Morpho Blue",
    strategy: "BSC 隔离池清算监听",
    mode: "monitor",
    rpc: "BNB_RPC_URL",
    priority: 74,
    minCapitalUsd: 8_000,
    note: "用于展示 BSC Morpho 类市场快照，执行侧等待远端策略确认。",
  },
  {
  ...
  {
    id: "arb-morpho-blue-liquidation",
    chain: "arbitrum",
    chainLabel: "ARB",
    protocol: "Morpho Blue",
    strategy: "Arbitrum 隔离池清算",
    mode: "execute",
    rpc: "ARBITRUM_RPC_URL",
    priority: 76,
    minCapitalUsd: 12_000,
    note: "覆盖 Arbitrum Morpho Blue 市场，候选账户可进入轮循队列。",
  },
  {
    id: "arb-spark-monitor",
    chain: "arbitrum",
    chainLabel: "ARB",
    protocol: "Spark",
    strategy: "Arbitrum Spark 清算监听",
    mode: "monitor",
    rpc: "ARBITRUM_RPC_URL",
    priority: 69,
    minCapitalUsd: 12_000,
    note: "展示 Arbitrum Spark 借贷市场快照，执行开关等待策略侧放量。",
  },
  {
